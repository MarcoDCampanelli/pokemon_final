...
export const UserProvider = ({ children }) => {
  ...
  // This will fetch a list of all natures in the game to be used to generate a list of natures as well as all types in the game
  ...
  useEffect(() => {
    ...
    fetch("https://pokeapi.co/api/v2/type/?limit=18&offset=0")
      .then((res) => res.json())
      .then((resData) => {
        setTypes(
          resData.results.map((result) => {
